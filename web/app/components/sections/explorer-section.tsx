...
// Exported so the settings section can offer "clear my saved data" resets
...
/**
 * True only once the client has hydrated: favorite teams / saved
 * searches live in `localStorage`,
  ...
  return (
    <section aria-label="Compare games" className="flex flex-col gap-3">
      <div className="flex flex-col gap-1">
        <h3 className="text-lg font-medium text-foreground">Compare games</h3>
        <p className="text-sm text-muted-foreground">
