 ...
 * calls, so this never drifts from that page's numbers. Shows PPG/RPG/APG
 * only (not the full profile's FG%/3P%/SPG/BPG/TOV/MPG spread) -- this is
 * a glance, not a substitute for "Full profile".
 *
